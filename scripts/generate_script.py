...
- [মূল ঘটনা] অংশে উৎস তথ্যের প্রতিটা গুরুত্বপূর্ণ ঘটনা, তারিখ, নাম আলাদা আলাদা করে বিস্তারিত বর্ণনা করো — সংক্ষেপে সারমর্ম না লিখে, যেন viewer পুরো ঘটনাটা চোখের সামনে দেখতে পায়। প্রতিটা section-এ কমপক্ষে ৪-৬টা বাক্য থাকা উচিত যদি উৎসে তথ্য থাকে।
"""
